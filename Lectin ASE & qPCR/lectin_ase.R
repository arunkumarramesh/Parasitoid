...
pdf("plots/ase_ins_hap_prop.pdf", height = 3, width = 7)
...
qpcr_melt <- qpcr
qpcr_melt$delta_ct_lectin <- qpcr_melt$ct_lectin - qpcr_melt$ct_rpl ## calculate delta ct by subtracting ct of lectin from rpl
