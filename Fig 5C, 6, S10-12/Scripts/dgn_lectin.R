...
ann_snpname2a <- ann_snpname2[1:5] ## correct downstream variant positions to reflect end of lectin-24a
ann_snpname2a <- paste("c.*",3716880-as.numeric(gsub("_.*","",gsub("2L_","",names(ann_snpname2a)))),gsub(".*[0-9]","",ann_snpname2a),sep="")
ann_snpname2[1:5] <- ann_snpname2a
ann_snpname2b <- ann_snpname2[38:45] ## correct upstream variant positions to reflect start of lectin-24a
ann_snpname2b <- paste("c.",ann_snpname_num[38:45],gsub(".*[0-9]","",ann_snpname2b),sep="")
ann_snpname2[38:45] <- ann_snpname2b
...
names(ann_snpname_pos) <- gsub("2L_","",names(ann_snpname))
names(ann_snpname_pos) <- gsub(".*_X","",names(ann_snpname_pos))
names(ann_snpname_pos) <- gsub("_.*","",names(ann_snpname_pos))
